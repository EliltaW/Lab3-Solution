...
public class Driver {
	...
	void addEmployee(String employeeId){
		//implement-- redo the implementation
		boolean add = directory.addNewEmployee(employeeId);
		if(add==true) 
	...
	void addBook(String bookId){
		//implement-- redo the implementation
		boolean addBoo = directory.addNewBook(bookId);
		if(addBoo == true) 
	...
	void addCD(String cdId){
		//implement-- redo the implementation
		boolean addc = directory.addNewCD(Integer.parseInt(cdId));
		if(addc == true) 
	...
	void checkIfBookIsInStock(String bookId){
		//implement-- redo the implementation
		boolean check = directory.bookIsInStock(bookId);
		if(check == true) 
	...
	void displayNumberOfCDsInBookstore(){
		//implement-- redo the implementation
		int cdNum = directory.getNumberOfBooks();
		if(cdNum > -1) {
	...
	void checkWhetherFoodItemInMarket(String foodItem){
		//	implement-- redo the implementation
	boolean food = directory.marketCarriesFoodItem(foodItem);
